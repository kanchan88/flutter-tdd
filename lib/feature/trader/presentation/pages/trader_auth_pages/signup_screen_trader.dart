...
class SignUpScreenTrader extends StatefulWidget {
  const SignUpScreenTrader({Key? key}) : super(key: key);

  @override
  State<SignUpScreenTrader> createState() => _SignUpScreenTraderState();
}

class _SignUpScreenTraderState extends State<SignUpScreenTrader> {
                    ...
                    child: Center(
                      child: BlocConsumer<TraderAuthBloc, TraderAuthState>(
                        builder: (context, state){
                                      ...
                                      child: ElevatedButton(
                                        onPressed: () {
                                          if (_signUpFormKey.currentState!.validate()) {
                                            ...
                                            BlocProvider.of<TraderAuthBloc>(context).add(TraderAuthRegisterEvent(user: user, pass: passwordTFC.text));
                          ...
                          } else if ( state is TraderAuthLoadedState){
                            return Center(
                              child: Column(
