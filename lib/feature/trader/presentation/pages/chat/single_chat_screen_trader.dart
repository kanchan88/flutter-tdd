...
import 'package:workoneerweb/feature/trader/presentation/pages/chat/chat_container_trader.dart';


class SingleChatScreenTrader extends StatefulWidget {

  final String chatId;
  final String traderId;

  const SingleChatScreenTrader({required this.chatId, required this.traderId, Key? key}) : super(key: key);

  @override
  State<SingleChatScreenTrader> createState() => _SingleChatScreenTraderState();
}

class _SingleChatScreenTraderState extends State<SingleChatScreenTrader> {
    ...
    return Container(
      child: MultiBlocProvider(
        ...
        child: Padding(
          ...
          child: ChatContainerTrader(chatId: widget.chatId, traderId: widget.traderId,),
        ),
      ),
    );
  }
