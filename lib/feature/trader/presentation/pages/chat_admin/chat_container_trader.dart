...
class ChatContainerTraderAdmin extends StatefulWidget {

  final String chatId;
  final String traderId;

  const ChatContainerTraderAdmin({required this.chatId, required this.traderId, Key? key}) : super(key: key);

  @override
  State<ChatContainerTraderAdmin> createState() => _ChatContainerTraderAdminState();
}

class _ChatContainerTraderAdminState extends State<ChatContainerTraderAdmin> {
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          BlocConsumer<AdminMessagesBloc, AdminMessagesState>(
              builder: (context, state) {

                if(state is SendAdminMessagesLoadingState){
                ...
                return IconButton(
                  ...
                  onPressed: () {
                    ...
                    BlocProvider.of<AdminMessagesBloc>(context)
                        .add(SendMessageToAdminEvent(jobId: widget.chatId, traderId: widget.traderId, message: messageTEC.text));
  ...
  void initState() {
    BlocProvider.of<AdminMessagesBloc>(context)
        .add(FetchAllMessagesWithAdminEvent(jobId: widget.chatId, traderId: widget.traderId));
    super.initState();
  }
          ...
          child: ListView(
            ...
            children: [
              ...
              SizedBox(
                ...
                child: BlocBuilder<AdminMessagesBloc, AdminMessagesState>(

                  builder: (context, state) {

                    if(state is AdminMessagesLoadingState){
                      return const LoadingData();
                    }

                    else if(state is AdminMessagesLoadedState){
