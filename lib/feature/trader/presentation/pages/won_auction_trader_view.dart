...
import 'package:workoneerweb/feature/trader/presentation/containers/single_won_trader_view.dart';
      ...
      body: ListView(
        children: [
          ...
          MultiBlocProvider(
            ...
            child: const SingleWonTraderView(),
