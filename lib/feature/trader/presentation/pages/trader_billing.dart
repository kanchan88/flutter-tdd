...
class BillingViewTrader extends StatefulWidget {

  const BillingViewTrader({Key? key}):super(key: key);

  @override
  State<BillingViewTrader> createState() => _BillingViewTraderState();
}

class _BillingViewTraderState extends State<BillingViewTrader> {
