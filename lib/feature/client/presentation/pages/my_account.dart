...
class ShowMyAccountClient extends StatefulWidget {

  const ShowMyAccountClient({Key? key}):super(key: key);

  @override
  State<ShowMyAccountClient> createState() => _ShowMyAccountClientState();
}

class _ShowMyAccountClientState extends State<ShowMyAccountClient> {
        ...
        builder: (BuildContext context) {
          return Dialog(
            child: SizedBox(
              ...
              child: BlocConsumer<ClientAccountUpdateBloc, ClientUpdateState>(
                builder: (context, state) {
                  if(state is ClientPassLoading){
                    return Padding(
                          ...
                          TextButton(
                            onPressed: (){
                              if(_resetPassKey.currentState!.validate()){
                                ...
                                BlocProvider.of<ClientAccountUpdateBloc>(context).add(
                                    ClientPostResetPassword(
                ...
                listener: (context, state){
                  if(state is ClientResetPassSuccess){
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          BlocConsumer<ClientAccountUpdateBloc, ClientUpdateState>(
                            listener: (context, state){
                              if(state is ClientUpdateLoading){
                                Fluttertoast.showToast(msg: 'Updating....');
                              }
                              else if (state is ClientUpdateFailed){
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Row(
                                                    mainAxisAlignment: MainAxisAlignment.start,
                                                    children: [
                                                      // TODO: sharedpref save user photoUrl
                                                      CircleAvatar(
                                                        ...
                                                        children: [
                                                          GestureDetector(
                                                            ...
                                                            SizedBox(
                                                              ...
                                                              width: 200,
                                                              child: TextFormField(
                                                                initialValue: Provider.of<LoginStateProvider>(context, listen: false).getFullName!,
                                                                onChanged: (val){
                                                                  setState(() {
                                                                    name = val;
                                                                  });
                                                                    ...
                                                                    suffix:IconButton(
                                                                      onPressed: (){
                                                                        ...
                                                                        BlocProvider.of<ClientAccountUpdateBloc>(context).add(
                                                                            ClientPostUpdate(
                                                                                userId: Provider.of<LoginStateProvider>(context, listen: false).getUserId!,
                                                                                name: name.isEmpty?Provider.of<LoginStateProvider>(context, listen: false).getFullName!:name,
                                                                                // TODO: sharedPref of phone is missing
                                                                                phone: phone.isEmpty?Provider.of<LoginStateProvider>(context, listen: false).getUserId!:phone
                                                                            )
                                                                        );
                                                            ...
                                                            Text(
                                                              Provider.of<LoginStateProvider>(context, listen: false).getFullName!,
                                                            ...
                                                            Container(
                                                              ...
                                                              child: Padding(
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child: Text(
                                                                    Provider.of<LoginStateProvider>(context, listen: false).getUserEmail!,
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            editPhone? TextFormField(
                                                              // TODO: sharedpref user phone
                                                              initialValue: Provider.of<LoginStateProvider>(context, listen: false).getUserType.toString(),
                                                              onChanged: (val){
                                                                setState(() {
                                                                  phone = val;
                                                                });
                                                              ...
                                                              child: Container(
                                                                ...
                                                                child: Padding(
                                                                  ...
                                                                  child: Padding(
                                                                    padding: const EdgeInsets.symmetric(horizontal: 16.0, vertical: 4.0),
                                                                    child: Text(
                                                                      // ToDo: Sharepref user phone
                                                                      Provider.of<LoginStateProvider>(context, listen: false).getUserType.toString(),
                                                                      style: const TextStyle(fontWeight: FontWeight.w600, color: Colors.grey),),
                                                                  ),
                                                                ),
                                                              ),
                                                    ...
                                                    Expanded(
                                                      child: Column(
                                                        ...
                                                        children: [
                                                          ...
                                                          editPhone? TextFormField(
                                                            // TODO: get shared pref email
                                                            initialValue: Provider.of<LoginStateProvider>(context, listen: false).getUserId,
                                                            onChanged: (val){
                                                              setState(() {
                                                                phone = val;
                                                              });
