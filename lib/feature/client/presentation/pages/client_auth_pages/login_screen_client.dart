...
//                            Map res = await UserAuth().resetPassword(email);
  ...
  Widget build(BuildContext context) {
    // if app show diff screen
      return SafeArea(
        child: ResponsiveUI.isMobile(context)? const UseAppDialog() : Scaffold(
                    ...
                    child: BlocConsumer<ClientAuthBloc, ClientAuthState>(
                              ...
                              child: Column(
                                ...
                                children: [
                                    ...
                                    child: ElevatedButton(
                                        onPressed: () {
                                          if (_loginKey.currentState!.validate()) {
                                            BlocProvider.of<ClientAuthBloc>(context).add(ClientAuthLoginEvent(username: emailTFC.text, pass: passwordTFC.text));
                                          }
                                        },
                                        style: ButtonStyle(
                                  ...
                                  SizedBox(
                                    ...
                                    child: ElevatedButton(
                                      onPressed: () {
                                        GoRouter.of(context).push('/client-register');
                                      },
                                      style: ButtonStyle(
                      ...
                      listener: (context, state) {
                        if(state is ClientAuthLoadedState){
                          ...
                          Provider.of<LoginStateProvider>(context, listen: false).addUserType(UserType.client);
