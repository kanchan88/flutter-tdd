...
class ChatContainer extends StatefulWidget {
  ...
  const ChatContainer({required this.chatId, required this.traderId, Key? key}) : super(key: key);
        ...
        children: [
          ...
          BlocConsumer<MessagesBloc, MessagesState>(
              builder: (context, state) {
                ...
                return sendingMessage? const SizedBox(
                  height: 20.0,
                  width: 20.0,
                  ...
                  onPressed: () {
                    ...
                    BlocProvider.of<MessagesBloc>(context)
                        .add(SendMessageToTraderEvent(jobId: widget.chatId, traderId: widget.traderId, message: messageTEC.text, userId: Provider.of<LoginStateProvider>(context,listen: false).getUserId.toString()));
