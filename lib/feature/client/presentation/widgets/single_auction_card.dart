...
class SingleAuctionCard extends StatelessWidget {

  final AuctionEntity auctionModel;

  const SingleAuctionCard({required this.auctionModel, Key? key}) : super(key: key);
        ...
        child: Row(
          ...
          children: [
            ...
            Padding(
              ...
              child: IconButton(
                onPressed: (){
                  if(auctionModel.status.toString().startsWith("REVIEW")){
